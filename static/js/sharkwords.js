...
const handleWrongGuess = () => {
  ...
  if (numWrong === 5) {
    ...
    document.querySelector('#correct-word').style.display = 'block';
  }
};
...
(function startGame() {
  ...
  // multiplying the length of the list to get a random
  ...
  document.querySelector('#correct-word').innerHTML = `The correct word was ${word}`
